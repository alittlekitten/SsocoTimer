...
**최신 업데이트 날짜 : `2022.04.21`**

**최신 릴리즈 버전 : `ver 1.5.2`**

![Honeycam 2022-04-10 05-21-00](https://user-images.githubusercontent.com/14370441/162590387-09ae26ae-0401-4c8b-82d1-22997ef38f62.gif)
...
- 링크를 전송했을 때 이미지와 간단한 설명이 포함되도록 하기 위해서 메인 페이지에 Open Graph를 적용해서 사용자가 페이지를 쉽게 파악할 수 있도록 구현하였습니다.
